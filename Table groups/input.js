...
function setup() {
    ...
    button = createButton('save names');
    button.position(300, 300);
    button.mousePressed(screen=screen+1);
    button.hide();
    ...
    button2 = createButton('randomize');
    button2.position(10, 19);
    button2.mousePressed(function(){name_arr = random_sets(shuffle(names_))});
    button2.hide();
